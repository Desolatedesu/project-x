...
domain = "g03u36.nn2000.info"
words = ('http://',domain, '/cgi-bin/main.py')
...
try:
	db = pymysql.connect(host = "127.0.0.1", user = "g03u36", passwd = "mysql16", db = "g03u36", charset = "utf8", use_unicode = True)
except:
...
for result in db_all:
	if (int(result[0]) != 0):
		if (int(result[0]) == page_id):
			print ('''
				<li><a href="{}?page_id={}" class="active">
