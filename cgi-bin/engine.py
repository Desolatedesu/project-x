...
with open('../public/header.html', mode='r', encoding='utf-8', errors=None) as file_read:
	for line in file_read:
		print(line)

print('''
	<div class='main-piska'>
	''')

with open('../public/main-content.html', mode='r', encoding='utf-8', errors=None) as file_read:
	for line in file_read:
		print(line)

with open('../public/aside.html', mode='r', encoding='utf-8', errors=None) as file_read:
	for line in file_read:
		print(line)
